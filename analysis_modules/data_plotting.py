...
def plot_data(*args, **kwargs):
    ...
    toolbar.getN = MethodType(getN, toolbar)     # attach getN as a bound method tp toolbar
...
if __name__=='__main__':
    plot_data(np.arange(1000000),np.sin(5*np.pi/1000000*np.arange(1000000)),'.', N=100)
